...
app.put("/orders/:orderId/:productId/:index",isLogged,isOrderPendiente,(req,res)=>{
...
app.delete("/orders/:orderId/:productId/:index",isLogged,isOrderPendiente,(req,res)=>{
  let orderId= req.params.orderId;
  let productId=req.params.productId;
...
app.put("/orderConfirm/:orderId/:index",isLogged,(req,res)=>{
